...
const applicationsDuration = new Trend('paced_applications_duration', true);
const applicationsFailed = new Rate('paced_applications_failed');
const applicationsTransportFailed = new Rate('paced_applications_transport_failed');
const applicationsRequests = new Counter('paced_applications_requests');
...
export const options = {
    ...
    thresholds: {
        paced_applications_failed: ['rate==0'],
        paced_applications_transport_failed: ['rate==0'],
        checks: ['rate==1'],
    },
};
...
export default function (data) {
    ...
    // Controlled paced workload: 1s think-time between application-list requests.
    sleep(1);
}
