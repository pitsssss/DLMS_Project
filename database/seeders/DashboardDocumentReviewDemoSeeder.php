    ...
    private function demoCitizens(): array
    {
        ...
        $records = [
            [
                ...
                'email' => 'doc.review.citizen1@example.com',
                'phone' => '0991000001',
                'national_id' => '02010098701',
                'birth_date' => '1994-02-10',
                'governorate' => 'دمشق',
                'address' => 'دمشق — الميدان — شارع بغداد — بناء 8',
            ],
            [
                'name' => 'أحمد محمود الحسن',
                'email' => 'doc.review.citizen2@example.com',
                'phone' => '0991000002',
                'national_id' => '02010098702',
                'birth_date' => '1991-08-25',
                'governorate' => 'حلب',
                'address' => 'حلب — العزيزية — شارع الرئيس — عمارة 12',
            ],
            [
                'name' => 'سارة علي محمد',
                'email' => 'doc.review.citizen3@example.com',
                'phone' => '0991000003',
                'national_id' => '02010098703',
                'birth_date' => '1997-06-03',
                'governorate' => 'حمص',
                'address' => 'حمص — الوعر — شارع الحضارة — طابق 2',
            ],
            [
                'name' => 'ليلى حسن يوسف',
                'email' => 'doc.review.citizen4@example.com',
                'phone' => '0991000004',
                'national_id' => '02010098704',
                'birth_date' => '2000-12-19',
                'governorate' => 'اللاذقية',
                'address' => 'اللاذقية — الزقاق — قرب الساحة الرئيسية',
            ],
            [
                'name' => 'عمر سامي ناصر',
                'email' => 'doc.review.citizen5@example.com',
                'phone' => '0991000005',
                'national_id' => '02010098705',
                'birth_date' => '1989-04-07',
                'governorate' => 'طرطوس',
                'address' => 'طرطوس — الصفصافة — شارع الكورنيش — بناء 3',
            ],
        ];
