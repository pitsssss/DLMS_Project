...
final class NotificationEventMatrix
{
    ...
    public static function entries(): array
    {
        return [
            ...
            ['type' => 'application.rejected', 'domain' => 'application', 'coverage' => 'implemented', 'phase' => 'N2', 'notes' => 'ApplicationUnblockService::rejectApprovedUnblockApplication'],
            ...
            ['type' => 'application.completed', 'domain' => 'application', 'coverage' => 'implemented', 'phase' => 'N2', 'notes' => 'ApplicationUnblockService::unblockFromApplication'],
