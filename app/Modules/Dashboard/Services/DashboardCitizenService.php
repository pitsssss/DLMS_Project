...
class DashboardCitizenService
{
    ...
    public function activate(User $actor, int $citizenId): User
    {
        ...
        try {
            $this->notifications->sendToUser(
                $citizen->id,
                __('messages.notifications.account_activated_title'),
                __('messages.notifications.account_activated_body'),
                'account.activated',
            );
        } catch (\Throwable) {
        }
    ...
    public function deactivate(User $actor, int $citizenId, string $reason): User
    {
        ...
        try {
            $this->notifications->sendToUser(
                $citizen->id,
                __('messages.notifications.account_deactivated_title'),
                __('messages.notifications.account_deactivated_body', ['reason' => $reason]),
                'account.deactivated',
            );
        } catch (\Throwable) {
        }
