    ...
    return folder(
        ...
        [
            req(
                ...
                hdrs=H_CITIZEN,
                query=[("per_page", "20")],
                description=desc("Paginated notifications (data.items).", "Inbox.", "", "notification_id"),
            ...
            req(
                ...
                "/notifications",
                hdrs=H_CITIZEN,
                query=[("per_page", "20"), ("unread_only", "1")],
                description=desc("Unread filter if supported by API query.", "Badge / unread list."),
                event=tests(CAPTURE_NOTIFICATIONS),
            ),
            req(
                ...
                hdrs=H_CITIZEN,
                description=desc("Marks one notification read.", "Tap notification."),
                event=tests(),
            ),
        ],
    )
